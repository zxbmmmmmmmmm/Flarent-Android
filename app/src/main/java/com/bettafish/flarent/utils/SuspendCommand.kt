...
class SuspendCommand(val func: suspend () -> Unit, val coroutineScope: CoroutineScope, var onCompleted: () -> Unit = {}){
...
class SuspendCommand1<T1>(val func: suspend (arg1:T1) -> Unit, val coroutineScope: CoroutineScope, var onCompleted: () -> Unit = {}){
    val canExecute = MutableStateFlow(true)
